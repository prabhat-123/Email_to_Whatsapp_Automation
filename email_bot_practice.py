...
required_fields = ['User City','User State','User Phone','User Email','User Area','User Requirement','Search Date & Time']
...
def fetch_email():
    if os.path.exists('checkpoint.txt'):
        ...
        for num in search_data[0].split():
            ...
            # print(date_time_dt)
            if date_time_dt > checkpoint_date and 'Enquiry' in header_subject:
